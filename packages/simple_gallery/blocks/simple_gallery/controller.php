...
class Controller extends BlockController
{
    ...
    public function on_start() {
        ...
        $lightboxCaption_options['none']       = t('Do not display captions');
        $lightboxCaption_options['file_title'] = t('Display captions based on File Title');
        $lightboxCaption_options['page_title'] = t('Display common caption based on Page Title');
    ...
    public function view() {
        ...
        // Localization
        $al->register('javascript-localized', 'simple-gallery/localization', 'simple-gallery/localization', ['combine' => false, 'minify' => false]);
        $this->requireAsset('javascript-localized', 'simple-gallery/localization');
    ...
    private function renderCss() {
        ...
        $uniqueParentContainer = '.sg-'.$this->uniqueID;
