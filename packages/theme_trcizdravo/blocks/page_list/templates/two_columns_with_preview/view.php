...
<div class="single_post_content">
        ...
        <ul class="business_catgnav  wow fadeInDown animated " style="visibility: visible; animation-name: fadeInDown;">
            <li class="box-shadow-wrapper">
                <figure class="bsbig_fig">
                    ...
                    <p class="page-list-description" style="padding-left: 5px;padding-right: 5px;"><?php echo  $description;?></p>
                </figure>
            </li>
        </ul>
    </div>
    <div class="single_post_content_right">
        ...
        <?php for($i=1;$i<count($pages);$i++){
            ...
            ?>
            <li class="box-shadow-wrapper media wow fadeInDown animated">
                <div class="" style="visibility: visible; animation-name: fadeInDown;">
