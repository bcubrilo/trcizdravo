...
if (count($navItems) > 0) {
    $ni = $navItems[0];
    echo '<ul class="nav navbar-nav main_nav">'; //opens the top-level menu
    echo '<li class="active"><a href="'.$ni->url.'"><span class="fa fa-home desktop-home"></span><span class="mobile-show">'.t('Početna').'</span></a></li>';
