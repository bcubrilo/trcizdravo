 ...
 * });
*/
Route::register('/dashboard/express/plan_treninga\{entityID}','\Application\Controller\SinglePage\Dashboard\Express\PlanTreninga::view');
Route::register('/ccm/predvidi-rezultate/{d}/{t}','\Application\Block\KalkulatorTrcanja\Controller::predvidiRezultate');
/*
 *
 *
 * ## Override an Asset
